...
<!-- SIDEBAR -->
  <section id="sidebar" class="always-visible">
        ...
        <ul class="side-menu">
            ...
            <li><a href="item_monitoringg.php"class="active"><i class='bx bxs-report icon'></i> Monitoring Equipment </a></li>
        ...
        <!-- MAIN -->
         <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">/</li>
                <li><a href="dashboardd.php" class="active">Monitoring Equipment</a></li>
            </ul>
